...
import { reservationApi } from "../../features/reservation/services/reservationApi"; 
...
function HoldModal({ book, onClose, onSuccess }) {
  ...
  const handleHold = async () => {
    try {
      ...
      // Trigger callback để component cha (BookList/BookDetail) fetch lại dữ liệu mới nhất
